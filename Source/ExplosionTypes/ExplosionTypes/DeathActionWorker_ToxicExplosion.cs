...
namespace ExplosionTypes
{
    public class DeathActionWorker_ToxicExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, Named("GR_ToxicExplosion"), corpse.InnerPawn, -1,SoundDef.Named("Explosion_Bomb"), null, null, null, ThingDef.Named("GR_Poison_Gas"), 1f, 1, false, null, 0f, 1);
        }

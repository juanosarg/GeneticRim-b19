...
namespace ExplosionTypes
{
    public class DeathActionWorker_EMPExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.EMP, corpse.InnerPawn, -1,null, null, null, null, ThingDef.Named("Gas_Smoke"), .7f, 1, false, null, 0f, 1);
        }
